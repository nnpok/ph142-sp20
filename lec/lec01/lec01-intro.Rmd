...
![What do you think of when you think about statistics?](word_cloud.png)
...
GSIs (short bios are on bcourses)
Asem Berkalieva, Aidean McLoughlin, Sophia (Sophie) Fuller, Yi Li, Dorothy Chen, and Hao Wang.

Course tutors:
Cam Adams, Simran Bajwa
...
Discussion: Review of key concepts, application of knowledge to reading and writing in scientific litterature   

###Waitlist status and Section shifting
As of today it looks like almost all wait-listed students should be able to enroll
...
###Accomodations
Make requests in writing by February 1st so that any accommodations can be implemented in time for the first midterm exam

If your DSP accomodation allows extension on take home assignments we ask that you discuss your request no later than 24 hours after the assignment is posted. 

If you need an accomodation but do not yet have an official letter apply as soon as possible: https://dsp.berkeley.edu/students/new-students.


###Communication
**Please please please ask questions!!!**

Questions during lecture, discussion and lab section are strongly encouraged. If something is unclear to you, it is probably unclear to many others in the room. 

**Use the discussion board**

We will use piazza for class announcements and discussion. 

**Email** only for logistical or non-content related issues


###Office hours
GSIs will hold office hours every week - office hours will be posted on the website
...
![Will I get an A?](crystalball.jpg)
...
![From PHDcomics.com](science_news_cycle.png)
