...
**5. Modify your scatter plot by linking the color of the points to the variable
`Income_Group`.**
...
**6. For this lab, we would like to use linear regression. To do this, use a 
...
**7. Remake the last scatter plot, this time using `CS_data_sub` to see if the 
...
**8. Given that the relationship is approximately linear, use linear regression to 
...
cd; cd ph142-sp20/lab/lab02; python3 turn_in.py
