#################################################
# Autograder tests for PH142 lab11 for student
...
check_problem2 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = round(p_value,4)==0.0017, 
             correct_message = "Full pay is right range",
             error_message = "Full pay is out of right range")
...
check_problem3 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = round(p_value_using_code,4)==0.0017, 
             correct_message = "Full pay is right range",
             error_message = "Full pay is out of right range")
...
check_problem5 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = round(p_value_chisq,4)==0.0017, 
             correct_message = "Full pay is right range",
             error_message = "Full pay is out of right range")
