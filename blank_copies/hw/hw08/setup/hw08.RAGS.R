...
check_problem4 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(CI_upperbound)== "numeric", 
             correct_message = "Passed.",
             error_message = "Incorrect.")
  
  checkpoint(checkpoint_number = 2,
             test = class(CI_lowerbound)=="numeric",
             correct_message = "Passed.",
             error_message = "Incorrect."
  )
...
check_problem6 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(t_statistics) == "numeric", 
             correct_message = "Passed.",
             error_message = "Incorrect.")
  
  checkpoint(checkpoint_number = 2,
             test = round(t_statistics, 2) < 2,
             correct_message = "Passed.",
             error_message = "Incorrect."
  )
...
check_problem7 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p_value) == "numeric", 
             correct_message = "Passed.",
             error_message = "Incorrect.")
  
  checkpoint(checkpoint_number = 2,
             test = round(p_value, 2) < 0.3,
             correct_message = "Passed.",
             error_message = "Incorrect."
  )
...
check_problem10 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p_value_10) == "numeric", 
             correct_message = "Passed.",
             error_message = "Incorrect.")
  
  checkpoint(checkpoint_number = 2,
             test = round(p_value_10, 2) < 0.1,
             correct_message = "Passed.",
             error_message = "Incorrect.")
...
check_problem12 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(CI_upperbound_12) == "numeric", 
             correct_message = "Passed.",
             error_message = "Incorrect.")
  
  checkpoint(checkpoint_number = 2,
             test = class(CI_lowerbound_12) == "numeric",
             correct_message = "Passed.",
             error_message = "Incorrect.")
...
check_problem13 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = p13 == "-2.30 to -0.70" |
               p13 == "-1.20 to 0.90" |
               p13 == "1.50 to 3.80" |
               p13 == "4.50 to 6.90",
             correct_message = "Passed.",
             error_message = "Please uncomment one of the choices, but don't change the text.")
...
check_problem14 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = p14 == "Both a 95% CI and a 99% CI will contain 0." |
