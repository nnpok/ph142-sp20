#################################################
# Autograder tests for PH142 hw11 for student
...
check_problem2 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = full_pay<110 & full_pay>90, 
             correct_message = "Full pay is right range",
             error_message = "Full pay is out of right range")
  
  checkpoint(checkpoint_number = 2,
             test = partial_pay<40,
             correct_message = "Partial pay is in right range",
             error_message = "Partial pay is out of right range"
  )
  checkpoint(checkpoint_number = 3,
             test = no_pay<90,
             correct_message = "no pay is in right range",
             error_message = "no pay is out of right range"
  )
...
check_problem4 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(chi_sq_answer)=="numeric", 
             correct_message = "You answer is correct",
             error_message = "Answer should be numeric")
  
  checkpoint(checkpoint_number = 2,
             test = chi_sq_answer<100,
             correct_message = "Your answer in right range",
             error_message = "Your answer is out of right range"
  )
...
check_problem5 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(largest_contribution)=="character", 
             correct_message = "You have unmuted one answer",
             error_message = "You should unmute one answer")
...
check_problem6 = function() {
  ...
  checkpoint(checkpoint_number = 2,
             ...
             error_message = "Your answer is not numeric"
  )
...
check_problem7 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(conclusion)=="character", 
             correct_message = "You have unmuted one answer",
             error_message = "You should unmute one answer")
...
check_problem8 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(variable_type)=="character", 
             correct_message = "You have unmuted one answer",
             error_message = "You should unmute one answer")
...
check_problem11 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(A)=="numeric", 
             correct_message = "A is numeric",
             error_message = "A is not numeric")
  
  checkpoint(checkpoint_number = 2,
             test =class(B)=="numeric", 
             correct_message = "B is numeric",
             error_message = "B is not numeric")
  
  checkpoint(checkpoint_number = 3,
             test = class(C)=="numeric",  
             correct_message = "C is numeric",
             error_message = "C is not numeric")
  
  checkpoint(checkpoint_number = 4,
             test = class(D)=="numeric",  
             correct_message = "D is numeric",
             error_message = "D is not numeric")
  
  checkpoint(checkpoint_number = 5,
             test = class(E)=="numeric",  
             correct_message = "E is numeric",
             error_message = "E is not numeric")
  
  checkpoint(checkpoint_number = 6,
             test = class(G)=="numeric", 
             correct_message = "G is numeric",
             error_message = "G is not numeric")
  
  checkpoint(checkpoint_number = 7,
             test = class(H)=="numeric",  
             correct_message = "H is numeric",
             error_message = "H is not numeric")
  
  
  checkpoint(checkpoint_number = 8,
             test =class(I)=="numeric", 
             correct_message = "I is numeric",
             error_message = "I is not numeric")
  
  checkpoint(checkpoint_number = 9,
             test = class(J)=="numeric",  
             correct_message = "J is numeric",
             error_message = "J is not numeric")
  
  checkpoint(checkpoint_number = 10,
             test = class(K)=="numeric",  
             correct_message = "K is numeric",
             error_message = "K is not numeric")
  
  checkpoint(checkpoint_number = 11,
             test = class(L)=="numeric",  
             correct_message = "L is numeric",
             error_message = "L is not numeric")
  
  checkpoint(checkpoint_number = 12,
             test = class(M)=="numeric",  
             correct_message = "M is numeric",
             error_message = "M is not numeric")
...
check_problem12 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(chi_sq_p12)=="numeric", 
             correct_message = "You answer is numeric",
             error_message = "Answer should be numeric")
  
  checkpoint(checkpoint_number = 2,
             test = chi_sq_p12<100,
             correct_message = "Your answer is in right range",
             error_message = "Your answer is out of right range"
  )
...
check_problem13 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p_value_p13)=="numeric", 
             correct_message = "You answer is numeric",
             error_message = "Answer should be numeric")
  
  checkpoint(checkpoint_number = 2,
             test = p_value_p13<0.1,
             correct_message = "Your answer is in right range",
             error_message = "Your answer is out of right range"
  )
...
check_problem14 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(conclusion_p14)=="character", 
             correct_message = "You have unmuted one answer",
             error_message = "You should unmute one answer")
