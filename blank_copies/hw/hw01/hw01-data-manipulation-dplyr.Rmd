...
**12. [2 points] Suppose you are interested in the order of longest sleep time to shortest sleep time, but according to whether the animal is a carnivore, herbivore, or omnivore. Rewrite the above statement to order sleep time according to the type of "-vore" that then animal is:**
