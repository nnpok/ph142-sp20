...
8. [2 points] First, create a tibble storing your CIs using the example code below. Then, create a plot comparing the confidence intervals. If you are stuck, refer back to the example code presented in Lab 10. 
