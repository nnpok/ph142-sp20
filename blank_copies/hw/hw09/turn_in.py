...
ASSIGNMENT_RMD_PATH = 'hw09.Rmd'
COURSE_ID = 79434
PROGRAMMING_ASSIGNMENT_ID = 456674 
FRQ_ASSIGNMENT_ID = 456691 # only for HW's, comment out for labs
FRQ_Q_NUMS = [1, 2, 3, 4, 5, 9, 10, 19] # questions to be exported as FRQ (only for HW's)
