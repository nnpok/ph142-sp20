...
ASSIGNMENT_RMD_PATH = 'lab08-t-test.Rmd'
COURSE_ID = 79434
PROGRAMMING_ASSIGNMENT_ID = 443488 
FRQ_ASSIGNMENT_ID = None # only for HW's, comment out for labs
FRQ_Q_NUMS = [2, 3, 5, 8, 9, 11] # questions to be exported as FRQ (only for HW's)
