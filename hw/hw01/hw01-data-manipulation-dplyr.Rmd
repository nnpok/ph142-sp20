...
**5. [1 point] Run the following chunk of code. What does it return? Replace the line "YOUR ANSWER HERE" below with your one-sentence answer.**
...
5. If the submission fails, try to diagnose the issue using the error messages--if you have problems, contact your GSI. 
