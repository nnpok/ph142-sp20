...
ASSIGNMENT_RMD_PATH = 'hw10.Rmd'
COURSE_ID = 79434
PROGRAMMING_ASSIGNMENT_ID = 467451 
FRQ_ASSIGNMENT_ID = 467537 # only for HW's, comment out for labs
FRQ_Q_NUMS = [9,10,11,14,15,16,19,20,23] # questions to be exported as FRQ (only for HW's)

# Don't change these
PDF_PATH = ASSIGNMENT_RMD_PATH.replace('.Rmd', '.pdf')
FRQ_PATH = ASSIGNMENT_RMD_PATH.replace('.Rmd', '_frq.pdf')
BASE_URL = 'https://www.gradescope.com'
IS_QUESTION_START= re.compile(r'(\d+)[\.]? \[\d+ (point|mark)[s]?\]')
