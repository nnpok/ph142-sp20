...
ASSIGNMENT_RMD_PATH = 'hw11.Rmd'
COURSE_ID = 79434
PROGRAMMING_ASSIGNMENT_ID = 482343 
FRQ_ASSIGNMENT_ID = 482331 # only for HW's, comment out for labs
FRQ_Q_NUMS = [1,3,9,10] # questions to be exported as FRQ (only for HW's)
